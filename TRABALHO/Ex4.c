...
do lucro e o valor final do produto. Mostre na tela o valor do produto lido, o percentual
aplicado, o valor do lucro e o valor final.*/
#include <stdio.h>

    int main(){

        float prod, lucro, final, porc;
